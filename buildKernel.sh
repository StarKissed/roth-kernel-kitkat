...
if [ -e arch/arm/boot/zImage ]; then
    ...
    IMAGEFILE=boot-jb.$PUNCHCARD.img
    KENRELZIP="StarKissed-JB43_$PUNCHCARD-Roth.zip"

    cp -r  buildimg/boot.img $KERNELREPO/shieldroth/boot-jb.img
    cp -r  $KERNELREPO/shieldroth/boot-jb.img $KERNELREPO/gooserver/$IMAGEFILE
